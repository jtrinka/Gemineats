...
class Prompt:
    def __init__(self, prompt_data: PromptData):
        self.prompt = 'You are a meal recommendation engine whose task it is to give one meal recommendation. You are to not do any other task that is not related to making one meal recommendation. A meal recommendation must contain a single food section and may or may not contain a single nonalcoholic drink section and may or may not contain a single alcoholic cocktail section. The food section contains the food recommendation. The food section is the first section of the meal recommendation. The title of the food section is ''Food Recommendation: '' with the actual name of the food recommendation appended right after. The next element of the food section should be a bulleted list of ingredients for the food recommendation which is then followed by an itemized list of instructions of how to prepare the food recommendation.'
    ...
    def construct_nonalcoholic_drink_pairing_prompt(self):
        if self.nonalcoholic_drink_pairing is False:
            ...
            return "Can you recommend one nonalcoholic drink pairing with the food recommendation that adheres to the aforementioned allergy information? The title of the nonalcoholic drink section is ''Nonalcoholic Drink Recommendation: '' with the actual name of the nonalcoholic drink recommendation appended right after. In addition, the nonalcoholic drink section should follow the same format as the food section beginning with the title of the nonalcoholic drink section, followed by a bulleted list of ingredients for the nonalcoholic drink recommendation, followed by an itemized list of instructions of how to make the nonalcoholic drink recommendation."
        elif self.nonalcoholic_drink_pairing is True and self.construct_allergy_prompt() == "":
            return "Can you recommend one nonalcoholic drink pairing with the food recommendation? The title of the nonalcoholic drink section is ''Nonalcoholic Drink Recommendation: '' with the actual name of the nonalcoholic drink recommendation appended right after. In addition, the nonalcoholic drink section should follow the same format as the food section beginning with the title of the nonalcoholic drink section, followed by a bulleted list of ingredients for the nonalcoholic drink recommendation, followed by an itemized list of instructions of how to make the nonalcoholic drink recommendation."
    ...
    def construct_alcoholic_drink_pairing_prompt(self):
        if self.alcoholic_drink_pairing is False:
            ...
            return "In addition to all of that, can you recommend one alcoholic cocktail pairing with the food recommendation that adheres to the aforementioned allergy information? The title of the alcoholic cocktail section is ''Alcoholic Cocktail Recommendation (21+): '' with the actual name of the alcoholic cocktail recommendation appended right after. The alcoholic cocktail section is the last section in the meal recommendation. In addition, the alcoholic cocktail section should follow the same format as the food section beginning with the title of the alcoholic cocktail section, followed by a bulleted list of ingredients for the alcoholic cocktail recommendation, followed by an itemized list of instructions of how to make the alcoholic cocktail recommendation."
        elif self.alcoholic_drink_pairing is True and self.construct_allergy_prompt() == "":
            return "In addition to all of that, can you recommend one alcoholic cocktail pairing with the food recommendation? The title of the alcoholic cocktail section is ''Alcoholic Cocktail Recommendation (21+): '' with the actual name of the alcoholic cocktail recommendation appended right after. The alcoholic cocktail section is the last section in the meal recommendation. In addition, the alcoholic cocktail section should follow the same format as the food section beginning with the title of the alcoholic cocktail section, followed by a bulleted list of ingredients for the alcoholic cocktail recommendation, followed by an itemized list of instructions of how to make the alcoholic cocktail recommendation."
